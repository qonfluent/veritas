...
// A decoder tree is either a single opcde/args set or binary tree
...
// The tree and other information generated by creating a decoder tree
...
// Given a set of operations and associated data(register file map), create a decoder tree
// Decoder tree is a huffman tree of operations
export function createDecoderTree(ops: OperationDesc[], registerFiles: Record<RegisterFileName, RegisterFileDesc>): DecoderQueueEntry {
	...
	ops.forEach((op, opcode) => {
		...
		// Calculate number of bits required for arguments
...
// Create the mux tree for opcode/length
...
// Create a decoder tree module
// This module takes an instruction and outputs the opcode and arguments in one clock
